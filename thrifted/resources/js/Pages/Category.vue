...
{
    try {
        let response = await axios.get(`/category/${props.category_id}/books_pagination?page=${Page.value}`);
...
<template>
    <AuthenticatedLayout>
        ...
        <div class="flex w-full">
            <ShopByGenre class="w-1/6" />
            <div class="w-5/6   py-16 grid grid-cols-6">
                ...
                <div class="m-2 p-2 border rounded">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span>
                            ...
                            <Button icon="pi pi-heart" style="font-size: 0.5rem" severity="secondary" outlined />
